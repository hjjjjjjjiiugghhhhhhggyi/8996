...
local Window = OrionLib:MakeWindow({Name = "褐脚本V1.0.0   ", HidePremium = false, IntroEnabled = false, ConfigFolder = "SB2Mod"})
local Tab = Window:MakeTab({
	Name = "⭐主要的",
	Icon = "rbxassetid://1076375600",
	PremiumOnly = false
})
